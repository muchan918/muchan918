<h1 align="center">김유찬</h1>

<h3 align="center">Game Client Developer</h3>

<p align="center">
꾸준히 배우고 성장하며, 다양한 경험을 주는 게임을 만들고 싶습니다.
</p>
...
**DevelRocket**  
Unity Game Client Development Course  
2026.02.06 - 2026.09.17
...
**Team Leader / Client Programmer**  
2026.07 - 2026.09

타워 디펜스 · 경영 시뮬레이션 게임

- 동네게임즈 기업 협약 프로젝트
- 게임 시스템 기획 및 클라이언트 개발
- STOVE 플랫폼 정식 출시

`Unity` `C#` `Windows` `Team Project`
...
- 기획부터 개발·배포까지 전 과정 진행
- 모바일 환경을 고려한 게임 시스템 및 최적화
- Google Play 정식 출시

`Unity` `C#` `Android` `Solo Project`

🔗 **Link:** [![Google Play](https://img.shields.io/badge/Google%20Play-414141?style=flat-square&logo=googleplay&logoColor=white)](https://play.google.com/store/apps/details?id=com.DevelRocket.SevenDays&hl=ko)
